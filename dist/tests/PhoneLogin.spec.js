...
(0, test_1.test)('User can login with Phone', async ({ page }) => {
    const login = new LoginPage_1.LoginPage(page);
    await login.goto('/');
    await login.clickLogin();
    await login.loginWithPhone(loginData_1.loginData.validUser.phone, loginData_1.loginData.validUser.password);
...
//# sourceMappingURL=PhoneLogin.spec.js.map